...
public class morevanillashieldsClient implements ClientModInitializer {
    ...
    public static final EntityModelLayer copper_shield_model_layer = new EntityModelLayer(Identifier.of(morevanillashields.MOD_ID, "copper_shield"),"main");
    public static final EntityModelLayer magma_shield_model_layer = new EntityModelLayer(Identifier.of(morevanillashields.MOD_ID, "magma_shield"),"main");
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier LEATHER_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/leather_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier GOLD_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/gold_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier DIAMOND_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/diamond_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier NETHERITE_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/netherite_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier EMERALD_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/emerald_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier AMETHYST_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/amethyst_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier REDSTONE_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/redstone_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier COPPER_SHIELD_BASE = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/copper_shield_base"));
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier COPPER_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/copper_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier MAGMA_SHIELD_BASE = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/magma_shield_base"));
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier MAGMA_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/magma_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier OBSIDIAN_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/obsidian_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier COAL_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/coal_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier END_CRYSTAL_SHIELD_BASE_NOPATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/end_crystal_shield_base_nopattern"));
    ...
    public void onInitializeClient() {
        ...
        ModelPredicateProviderRegistry.register(ModItems.MAGMA_SHIELD, Identifier.of("blocking"),
                (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0f : 0.0f);
