...
public class morevanillashieldsClient implements ClientModInitializer {
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier COPPER_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/copper_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
    ...
    @SuppressWarnings("deprecation")
    public static final SpriteIdentifier MAGMA_SHIELD_BASE_NO_PATTERN = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of(morevanillashields.MOD_ID, "entity/magma_shield_base_nopattern"));
    @SuppressWarnings("deprecation")
