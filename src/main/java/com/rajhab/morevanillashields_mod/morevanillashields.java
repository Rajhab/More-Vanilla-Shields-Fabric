...
public class morevanillashields implements ModInitializer {
	...
	static {
		MOD_SHIELD_DECORATION = Registry.register(Registries.RECIPE_TYPE, Identifier.of(MOD_ID, "mod_shield_decoration"), new RecipeType<ModShieldDecoratorRecipe>() {});
		MOD_SHIELD_DECORATION_SERIALIZER = Registry.register(Registries.RECIPE_SERIALIZER, Identifier.of(MOD_ID, "mod_shield_decoration"), new SpecialRecipeSerializer<>(ModShieldDecoratorRecipe::new));
	}
