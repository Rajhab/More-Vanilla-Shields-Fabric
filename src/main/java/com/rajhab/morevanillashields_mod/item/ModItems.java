...
public class ModItems {
            ...
            new ShieldItem(new Item.Settings().maxDamage(750).component(DataComponentTypes.BANNER_PATTERNS, BannerPatternsComponent.DEFAULT)){
                ...
                public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
                    ...
                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                        tooltip.add(Text.translatable("item.moditems.end_crystal_shield_destroy_blocks_enabled").formatted(Formatting.DARK_AQUA));
                    }
    ...
    public static final Item COPPER_SHIELD = registerItem("copper_shield",
            new ShieldItem(new Item.Settings().maxDamage(325).component(DataComponentTypes.BANNER_PATTERNS, BannerPatternsComponent.DEFAULT)){
            });

    public static final Item MAGMA_SHIELD = registerItem("magma_shield",
            new ShieldItem(new Item.Settings().maxDamage(255).component(DataComponentTypes.BANNER_PATTERNS, BannerPatternsComponent.DEFAULT)){

                @Override
                public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {

                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                        tooltip.add(Text.translatable("item.moditems.magma_shield_burn_enabled").formatted(Formatting.DARK_AQUA));
                    }
    ...
    public static final Item REDSTONE_SHIELD = registerItem("redstone_shield",
            new ShieldItem(new Item.Settings().maxDamage(250).component(DataComponentTypes.BANNER_PATTERNS, BannerPatternsComponent.DEFAULT)){
                ...
                public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
                    ...
                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                        tooltip.add(Text.translatable("item.moditems.redstone_shield.particles_enabled").formatted(Formatting.DARK_AQUA));
                    }
    ...
    public static void itemGroupIngredients(FabricItemGroupEntries entries) {
        ...
        entries.addAfter(REDSTONE_SHIELD, COPPER_SHIELD);
        entries.addAfter(COPPER_SHIELD, MAGMA_SHIELD);
        entries.addAfter(MAGMA_SHIELD, OBSIDIAN_SHIELD);
