...
public class ModItems {
            ...
            new ShieldItem(new FabricItemSettings().maxDamage(750).group(ItemGroup.COMBAT)){
                ...
                public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
                    ...
                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                            tooltip.add(new TranslatableText("item.moditems.end_crystal_shield_destroy_blocks_enabled").formatted(Formatting.DARK_AQUA));
                    }
    ...
    public static final Item COPPER_SHIELD = registerItem("copper_shield",
            new ShieldItem(new FabricItemSettings().maxDamage(325).group(ItemGroup.COMBAT)){
            });

    public static final Item MAGMA_SHIELD = registerItem("magma_shield",
            new ShieldItem(new FabricItemSettings().maxDamage(255).group(ItemGroup.COMBAT)) {

                @Override
                public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {

                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                        tooltip.add(new TranslatableText("item.moditems.magma_shield_burn_enabled").formatted(Formatting.DARK_AQUA));
                    }
    ...
    public static final Item REDSTONE_SHIELD = registerItem("redstone_shield",
            new ShieldItem(new FabricItemSettings().maxDamage(250).group(ItemGroup.COMBAT)){

                @Override
                public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {

                    if(MinecraftClient.getInstance().options.advancedItemTooltips) {
                        tooltip.add(new TranslatableText("item.moditems.redstone_shield.particles_enabled").formatted(Formatting.DARK_AQUA));
                    }
